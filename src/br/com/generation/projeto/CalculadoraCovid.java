...
public class CalculadoraCovid {
	...
	*/
	...
	public int menuCovid(){
		...
		System.out.println("2 - *N pessoas contaminam quantas pessoas em certo periodo?"); // --> usu�rio coloca a quantidade de pessoas infectadas inicial
		System.out.println("3 - Faca seu pr�prio calculo");
